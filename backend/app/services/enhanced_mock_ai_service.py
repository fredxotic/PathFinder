...
class EnhancedMockAIService:
    def __init__(self):
        logger.info("🤖 Enhanced Mock AI Service initialized - Providing detailed analysis")
    
    async def analyze_decision(self, decision: DecisionInput) -> Dict[str, Any]:
        """Enhanced mock AI analysis with detailed, realistic responses"""
        
        logger.info(f"🧠 Enhanced Mock AI analyzing decision: {decision.title}")
